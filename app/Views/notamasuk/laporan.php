...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid  text-center">
            ...
            <h3 class="h3 mb-2 text-gray-800"> Laporan Data Nota Masuk<br></h3><br><br>
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><i class="nav-icon fas fa-print"></i> Laporan Data Nota Masuk</li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Vendor Receiver</th>
